...
<body>
	<div class="top-header" style="background-color:#88cef7">
		<div class="wrap">
			<!----start-logo---->
			<div class="logo">
				<a href="<%=request.getContextPath()%>/"><img
					src="https://file1.hutech.edu.vn/file/editor/homepage/stories/hinh34/logo%20CMYK-01.png" title="logo" height="50px" weight="50px" /></a>
			</div>
			<!----end-logo---->
			<!----start-top-nav---->
			<div class="top-nav " style="float: left;margin-top: 10px;">
				<ul>
					...
					<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Cửa hàng <span class="caret"></span></a>
						<ul class="dropdown-menu" style="background: #88cef7" id="danhmuc2">
						</ul></li>
					<li><a href="<%=request.getContextPath()%>/shipping">Thông tin giao hàng</a></li>
			...
			<div class="search-bar " style="float: left;">
				<form action="/laptopshop/search">
					<input type="text" name="name"><input type="submit" style="background-color: #006cfa;"
						value="Search" />
				</form>
			</div>
